...
WORKDIR /src
COPY ["DailyMed.WebAPI/DailyMed.WebAPI.csproj", "DailyMed.WebAPI/"]
...
RUN dotnet build "./DailyMed.WebAPI.csproj" -c $BUILD_CONFIGURATION -o /app/build

# This stage is used to publish the service project to be copied to the final stage
FROM build AS publish
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "./DailyMed.WebAPI.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=false
...
EXPOSE 8080
ENTRYPOINT ["dotnet", "DailyMed.WebAPI.dll"]
